...
---
# Radar Chart Card
![Radar Chart Card](../images/screenshots/cards/radar-chart.jpg)


A radar chart based on [chart.js](https://www.chartjs.org/docs/latest/charts/radar.html).

## Sample
```php
use Sanjab\Helpers\ChartData;
use Sanjab\Cards\RadarChartCard;
use Sanjab\Helpers\MaterialColors;

$this->cards[] = RadarChartCard::create('Incomes')
